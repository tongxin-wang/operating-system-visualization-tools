...
namespace EX2
{
    ...
    {
        public FormClosedEventHandler ClosetoMain
        {
        ...
        private void ucBtn_load_BtnClick(object sender, EventArgs e)
        {
            blockIn();
        }

        private void ucBtnExt_move_BtnClick(object sender, EventArgs e)
        {
            blockOut();
        }
    }
