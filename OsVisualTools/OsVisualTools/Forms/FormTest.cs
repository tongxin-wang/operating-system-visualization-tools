...
namespace BankerAlgorithm
{
    public partial class FormTest : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            //Image.FromFile
            //gActive.DrawImage()
            gActive.DrawImage(OsVisualTools.Properties.Resources.benefits, 50, 50);
            gActive.DrawImage(OsVisualTools.Properties.Resources.x, new Rectangle(50, 50, 80, 80));
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            g.DrawImage(OsVisualTools.Properties.Resources._1, new Point(100, 100));
